...
<html lang="en">
  ...
  ?>
      ...
      <div class="row intro py-1">
              ...
              <div class="col-sm-12 col-md img text-right">
                <img class="im" src="img/bank1.jpg" class="img-fluid pt-2">
              </div>
            </div>
          ...
          <br>
          <br>
          <h3 class="action" ><span style="font-family: 'Roboto Slab', serif">CHOOSE THE BELOW ACTIONS</h3></span>
